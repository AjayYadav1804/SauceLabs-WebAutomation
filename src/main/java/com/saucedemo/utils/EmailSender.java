...
public class EmailSender {
    ...
    public static void sendEmailWithAttachment(String attachmentPath) {
        ...
        try {
        	...
        	String toEmail = ConfigReader.getProperty("mail.toEmail");
        	String ccEmail = ConfigReader.getProperty("mail.toCC");
             String subject = ConfigReader.getProperty("mail.subject");
             String messageBody = ConfigReader.getProperty("mail.messageBody");
